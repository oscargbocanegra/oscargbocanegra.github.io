...
- The synchronized instruction set now follows Codex's repository guidance model: concise repository context, working agreements, validation boundaries, and explicit code-review rules.
